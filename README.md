...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the Google Translate library. The documentation is located at https://cloud.google.com/translate/docs. My goal is to use it to translate the text files into other languages.`
- [x] **Add, commit, and push to GitHub**.
